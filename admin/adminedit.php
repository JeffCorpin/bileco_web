              ...
              <table class="table text-nowrap mb-0 align-middle">
                <form method="post" action="navigate.php?id=<?=$id;?>">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                    <input type="text" class="form-control" name="middlename" value="<?=($middlename)?$middlename:'';?>">
                  </div>
                  </div>
                  <div class="row mb-3">
                    <label class="col-form-label col-sm-3">Last Name</label>
                    <div class="col-sm-6">
                    <input type="text" class="form-control" name="lastname" value="<?=($lastname)?$lastname:'';?>">
                    </div>
                  </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <div class="offset-sm-3 col-sm-3 d-grid">
                      <button name="btn-edit-user" type="submit" class="btn btn-primary" style="justify-content: center !important;">Submit</button>
                    </div>
                    <div class="col-sm-3 d-grid">
                      <a class="btn btn-danger" style="justify-content: center !important;" href="adminuser.php" role="button">Cancel</a>
                    </div>
                  </div>
                </form>
              </table>
