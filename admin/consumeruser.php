...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4">Consumers</h5>
      <a class="btn btn-primary" role="button" href="consumeradd.php" style="margin-bottom: 20px; margin-top: -18px;">Add</a>
      <?php
            $msg = Session::get("msg");
            if(isset($msg)){
              echo $msg;
