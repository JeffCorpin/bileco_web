...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">New Admin</h5>
                                ...
                                <form method="post" action="navigate.php">
                                    ...
                                    <div class="row mb-3">
                                        <div class="offset-sm-3 col-sm-3 d-grid">
                                            <button name="btn-add-user" type="submit" class="btn btn-primary" style="justify-content: center !important;">Submit</button>
                                        </div>
